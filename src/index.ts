...
//WORFLOW trigger version, user_change, doesn't send usable allow add to channels because bot is not in channels
/*//Import libraries
import type {Handler, HandlerEvent, HandlerContext, HandlerCallback} from "@netlify/functions";
...
//ORIGINAL team_join version (w/out bug fixes)
